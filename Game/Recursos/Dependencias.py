...
from ..Menu_AR.Menu_JuegoGanado import JuegoGanado
...
def crear_instancia_de_JuegoGanado():
    return JuegoGanado(nombre_global)
...
instancia_de_juegoganado = crear_instancia_de_JuegoGanado()
